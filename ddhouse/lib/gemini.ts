// NOTE: This functionality has been temporarily disabled to resolve a build error
// as the '@google/genai' package was not included as a dependency.
// The feature also appears to be unused in the current UI.
// To re-enable, install the package (`npm install @google/genai`) and uncomment the code below.
/*
