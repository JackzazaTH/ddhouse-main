const INITIAL_HOMES = [
  {
    id: 'ddh-001',
    name: 'เดอะ ซีรีน วิลล่า',
    description: 'ผลงานชิ้นเอกของสถาปัตยกรรมสมัยใหม่ เดอะ ซีรีน วิลล่า มอบการพักผ่อนอันเงียบสงบด้วยพื้นที่ใช้สอยแบบเปิดโล่ง ผนังกระจกขนาดใหญ่ และการเชื่อมต่อกับธรรมชาติโดยรอบอย่างลงตัว เหมาะสำหรับครอบครัวที่มองหาทั้งความสะดวกสบายและสไตล์',
    area: 250,
    bedrooms: 4,
    bathrooms: 3,
    images: [
    ...
    isFeatured: true,
    seo: {
      title: 'เดอะ ซีรีน วิลล่า - แบบบ้านสำหรับครอบครัวสมัยใหม่ | DDHOUSE',
      description: 'ค้นพบบ้านเดอะ ซีรีน วิลล่า ผลงานชิ้นเอกขนาด 250 ตร.ม. พร้อม 4 ห้องนอน 3 ห้องน้ำ สัมผัสการใช้ชีวิตที่เงียบสงบด้วยพื้นที่เปิดโล่งและการผสมผสานกับธรรมชาติ'
    }
  },
  {
    id: 'ddh-002',
    name: 'เออร์เบิน ลอฟท์',
    description: 'สัมผัสประสบการณ์การใช้ชีวิตในเมืองที่ดีที่สุดที่เออร์เบิน ลอฟท์ ด้วยองค์ประกอบการออกแบบสไตล์อินดัสเทรียล-ชิค เพดานสูงสองเท่าในห้องนั่งเล่น และระเบียงดาดฟ้าส่วนตัว บ้านหลังนี้ออกแบบมาเพื่อคนเมืองยุคใหม่',
    area: 180,
    bedrooms: 2,
    bathrooms: 2,
    images: [
    ...
    isFeatured: true,
    seo: {
      title: 'เออร์เบิน ลอฟท์ - บ้านสไตล์อินดัสเทรียล-ชิค | DDHOUSE',
      description: 'สำรวจบ้านเออร์เบิน ลอฟท์ ขนาด 180 ตร.ม. พร้อม 2 ห้องนอนและระเบียงดาดฟ้าส่วนตัว ออกแบบมาสำหรับคนเมืองที่มองหาสไตล์และฟังก์ชัน'
    }
  },
  {
    id: 'ddh-003',
    name: 'โคสตัล รีทรีต',
    description: 'ตื่นขึ้นมาพร้อมกับเสียงคลื่นในบ้านโคสตัล รีทรีต ที่สวยงามน่าทึ่งแห่งนี้ ด้วยทิวทัศน์มหาสมุทรแบบพาโนรามา การตกแต่งภายในที่สว่างและโปร่งสบาย และระเบียงกว้างขวางสำหรับความบันเทิงกลางแจ้ง ที่นี่คือสถานที่พักผ่อนริมชายหาดที่ดีที่สุด',
    area: 220,
    bedrooms: 3,
    bathrooms: 3,
    images: [
    ...
    isFeatured: true,
    seo: {
      title: 'โคสตัล รีทรีต - บ้านพักตากอากาศริมทะเล | DDHOUSE',
      description: 'บ้านโคสตัล รีทรีต มอบทิวทัศน์มหาสมุทรแบบพาโนรามาในพื้นที่ 220 ตร.ม. พร้อม 3 ห้องนอน สถานที่พักผ่อนริมชายหาดที่ดีที่สุดรอคุณอยู่'
    }
  },
   {
    id: 'ddh-004',
    name: 'เมาน์เทน ชาเลต์',
    description: 'ชาเลต์แสนสบายที่ตั้งอยู่ท่ามกลางขุนเขาแห่งนี้ผสมผสานเสน่ห์แบบชนบทเข้ากับสิ่งอำนวยความสะดวกที่ทันสมัย โดดเด่นด้วยเตาผิงหิน คานไม้เปลือย และหน้าต่างบานใหญ่ที่มองเห็นทิวทัศน์ภูเขาอันน่าทึ่ง',
    area: 190,
    bedrooms: 3,
    bathrooms: 2,
    images: [
  ...
  {
    id: 'ddh-005',
    name: 'มินิมอลลิสต์ คิวบ์',
    description: 'คำจำกัดความที่ชัดเจนของการออกแบบที่เรียบง่าย บ้านทรงลูกบาศก์เน้นเส้นสายที่สะอาดตา รูปทรงเรขาคณิต และโทนสีโมโนโครมเพื่อสร้างพื้นที่ที่ทั้งสงบและกระตุ้นความคิด',
    area: 160,
    bedrooms: 2,
    bathrooms: 2,
    images: [
  ...
  {
    id: 'ddh-006',
    name: 'ซับเออร์เบิน คลาสสิก',
    description: 'บ้านสำหรับครอบครัวที่สมบูรณ์แบบ ซับเออร์เบิน คลาสสิก มีห้องพักกว้างขวาง สวนหลังบ้านขนาดใหญ่ และการออกแบบที่ไร้กาลเวลา การจัดวางที่ใช้งานได้จริงและบรรยากาศที่อบอุ่นและเป็นกันเองทำให้เป็นสถานที่ที่เหมาะสำหรับการสร้างความทรงจำที่ยั่งยืน',
    area: 280,
    bedrooms: 5,
    bathrooms: 4,
    images: [
...
const INITIAL_TESTIMONIALS = [
  {
    id: 'test-001',
    title: 'ทำไม? คุณหมอ ถึงสร้างบ้านกับ DDHOUSE มากที่สุด',
  ...
  {
    id: 'test-003',
    title: 'ตอบโจทย์ทุกความต้องการ ใส่ใจทุกรายละเอียด',
