// NOTE: This file is duplicated at the root level (`/types.ts`).
// This is a workaround for a build issue with the seed script.
// Please keep both files in sync if you make changes here.
