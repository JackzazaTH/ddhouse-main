...
function Gallery() {
    ...
    const [parkingFilter, setParkingFilter] = useState<string>('any');
    ...
    const filteredHomes = useMemo(() => {
        return homes.filter(home => {
            ...
            const matchesParking = parkingFilter === 'any' || (home.parking !== undefined && home.parking >= Number(parkingFilter));
            const matchesArea = home.area >= minArea && home.area <= maxArea;

            return matchesSearch && matchesBedrooms && matchesBathrooms && matchesParking && matchesArea;
        });
    }, [homes, searchTerm, bedroomsFilter, bathroomsFilter, parkingFilter, areaRange]);
