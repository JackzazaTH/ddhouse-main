...
import "./globals.css";
// FIX: AppProvider is now used inside AppClientLayout to properly wrap client components
  ...
  return (
    <html lang="en">
      <body className={`${poppins.className} bg-gray-50 text-gray-800`}>
        {/* FIX: Moved AppProvider inside AppClientLayout to fix type errors and ensure context is available to all client components. */}
