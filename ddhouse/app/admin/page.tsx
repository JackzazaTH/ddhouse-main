...
export default function AdminPage() {
    ...
    const {
        ...
        loginLogs,
        handleAddLoginLog,
        calendarEvents, handleAddCalendarEvent, handleUpdateCalendarEvent, handleDeleteCalendarEvent,
        galleryAlbums, handleAddGalleryAlbum, handleUpdateGalleryAlbum, handleDeleteGalleryAlbum,
    } = useAppContext();
    ...
    return (
        <AdminPanel
            ...
            onAddGalleryAlbum={handleAddGalleryAlbum}
