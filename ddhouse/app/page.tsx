...
// NOTE: This component is now designed to be rendered by the main App.tsx router.
  ...
  return (
    <div className="space-y-12 md:space-y-20">
      ...
      <div className="animate-slide-in-up" style={{ animationDelay: '100ms' }}>
          <PromotionsSection homes={homes} onNavigate={onNavigate} />
      </div>
      ...
      <div className="animate-slide-in-up" style={{ animationDelay: '100ms' }}>
        <PromoGrid cards={promoCards} onNavigate={onNavigate} />
      </div>
