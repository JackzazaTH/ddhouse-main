...
const AdminPanel: React.FC<AdminPanelProps> = ({ 
  ...
  const downloadCSV = (data: any[], filename: string) => {
    ...
    const rows = data.map(row => {
      return keys.map(key => {
        const value = row[key];
        // Handle arrays and objects by stringifying them and escaping quotes
  ...
  const renderHomeTable = () => (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="p-4 border-b border-gray-100 flex justify-end">
          <button 
            onClick={() => downloadCSV(homes, 'homes_export')}
  ...
  const renderArticleTable = () => (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="p-4 border-b border-gray-100 flex justify-end">
          <button 
            onClick={() => downloadCSV(articles, 'articles_export')}
            className="text-sm text-green-600 hover:text-green-800 flex items-center gap-1"
          >
             <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
  ...
  const renderLeadsTable = () => (
    <div className="bg-white rounded-lg shadow overflow-hidden">
      <div className="p-4 border-b border-gray-100 flex justify-end">
          <button 
            onClick={() => downloadCSV(leads, 'leads_export')}
            className="text-sm text-green-600 hover:text-green-800 flex items-center gap-1"
          >
             <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-4l-4 4m0 0l-4-4m4 4V4" />
