...
const PortfolioCard: React.FC<{ project: PortfolioProject; onNavigate: (view: View, slug?: string) => void; }> = ({ project, onNavigate }) => (
    <div 
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="relative bg-gray-800 py-20 sm:py-24 md:py-32 rounded-xl overflow-hidden mb-12">
        <img src="https://picsum.photos/seed/portfolio-hero/1600/800" className="absolute inset-0 w-full h-full object-cover opacity-30" alt="Portfolio background" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
        {filteredProjects.map((project) => (
          <PortfolioCard key={project.id} project={project} onNavigate={onNavigate} />
        ))}
      </div>
