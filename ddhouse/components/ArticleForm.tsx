        ...
        <form onSubmit={handleSubmit}>
          <div className="p-8">
            ...
            <div className="space-y-4">
                ...
                <input type="text" name="slug" value={formData.slug} onChange={handleChange} placeholder="URL Slug (auto-generated)" className={`${inputClasses} bg-gray-700 cursor-not-allowed`} readOnly />
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <input type="date" name="publishedDate" value={formData.publishedDate} onChange={handleChange} className={`${inputClasses} [color-scheme:dark]`} required />
                </div>
