...
const PasswordModal: React.FC<PasswordModalProps> = ({ onClose, onSubmit }) => {
  ...
  return (
    <div className="fixed inset-0 bg-white/75 backdrop-blur-sm flex justify-center items-center z-[100]">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-sm p-8 animate-fade-in-down">
        ...
        <form onSubmit={handleSubmit}>
          <input
            ...
            className="w-full p-3 border border-gray-600 bg-gray-800 text-white rounded-md text-center focus:ring-2 focus:ring-accent focus:border-transparent outline-none placeholder-gray-400"
            placeholder="••••••••"
            autoFocus
          />
