  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex justify-center items-center z-[100]">
      <div className="bg-white rounded-lg shadow-2xl w-full max-w-sm p-8 animate-fade-in-down">
        <h2 className="text-xl font-bold text-primary mb-4 text-center">เข้าสู่ระบบผู้ดูแล</h2>
        <p className="text-center text-gray-600 mb-6">กรุณากรอกรหัสผ่านเพื่อดำเนินการต่อ</p>
        <form onSubmit={handleSubmit}>
          <input
            type="password"
            value={password}
            onChange={(e) => setPassword(e.target.value)}
            className="w-full p-3 border border-gray-300 bg-gray-50 rounded-md text-center focus:ring-2 focus:ring-accent focus:border-transparent outline-none placeholder-gray-400"
            placeholder="••••••••"
            autoFocus
          />
