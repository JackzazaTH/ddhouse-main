      ...
      <div className="container mx-auto px-4 py-8">
        <div className="flex flex-col md:flex-row justify-between items-center text-center md:text-left gap-6">
          <div className="flex-1">
            <h3 className="text-xl font-bold text-primary">{siteInfo.siteName}</h3>
          ...
          <div className="flex flex-col items-center md:items-end gap-4 flex-1">
            ...
            <div className="flex items-center gap-4 mt-2">
              ...
              <a href={siteInfo.socials.whatsapp} target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-transform duration-300 hover:scale-110"><WhatsAppIcon className="w-6 h-6" /></a>
            </div>
          </div>
        </div>
