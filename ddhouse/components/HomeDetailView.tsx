            ...
            {home.images.map((img, index) => (
              <div key={index} className="relative w-24 h-24 flex-shrink-0">
                <Image
                  ...
                  className={`object-cover rounded-md cursor-pointer border-4 ${mainImage === img ? 'border-primary' : 'border-transparent'} hover:border-secondary transition-all duration-300 hover:scale-105 hover:shadow-md`}
                />
              </div>
            ))}
          </div>
