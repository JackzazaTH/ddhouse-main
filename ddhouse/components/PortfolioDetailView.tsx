...
const PortfolioDetailView: React.FC<PortfolioDetailViewProps> = ({ project, onBack, onContactClick }) => {
  ...
  const BackButton = () => (
    <button onClick={onBack} className="mb-6 bg-secondary text-white px-4 py-2 rounded-lg hover:bg-primary transition-colors duration-300 flex items-center space-x-2 w-max">
    ...
    <div className="bg-white p-4 sm:p-8 rounded-xl shadow-2xl animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          <button onClick={onContactClick} className="w-full mt-6 bg-secondary text-white font-bold py-3 px-8 rounded-lg hover:bg-primary transition-colors duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-1">
